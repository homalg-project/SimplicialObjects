#############################################################################
##  
##  PackageInfo.g for the package `SimplicialObjects'        Mohamed Barakat
##                                                                Ana Romero
...
#
PackageName := "SimplicialObjects",

##  This may be used by a default banner or on a Web page, should fit on
##  one line.
Subtitle := "Topology via Simplicial Sets",
...
# 
ArchiveURL := Concatenation( "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/SimplicialObjects/SimplicialObjects-", ~.Version ),
...
Persons := [
  ...
  rec(
    ...
    WWWHome       := "http://www.unirioja.es/cu/anromero/",
    PostalAddress := Concatenation( [
                       "Ana Romero\n",
...
#
README_URL := 
  "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/SimplicialObjects/README.SimplicialObjects",
PackageInfoURL := 
  "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/SimplicialObjects/PackageInfo.g",
...
PackageDoc := rec(
  # use same as in GAP            
  BookName  := "SimplicialObjects",
  # format/extension can be one of .zoo, .tar.gz, .tar.bz2, -win.zip
  Archive := 
    "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/SimplicialObjects/SimplicialObjects.tar.gz",
  ...
  LongTitle := "Topology via simplicial sets",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [["GAPDoc", ">= 1.0"], ["homalg", ">= 2010.03.19"]],
...
BannerString := Concatenation( 
  "----------------------------------------------------------------\n",
  "Loading  SimplicialObjects ", ~.Version, "\n",
...
Keywords := ["simplicial sets", "eilenberg maclane spaces", "loop spaces", "Kan extension property", "fibrations"]
